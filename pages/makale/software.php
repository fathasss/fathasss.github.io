...
<div class="w3-black" id="tour">
    <div class="w3-container w3-content w3-padding-64" style="max-width:1000px">
      ...
      <ul class="w3-ul w3-border w3-white w3-text-grey">
		...
		<h4 style="text-align:center"><b>BİLGİSAYAR YAZILIMLARI HAKKINDA </b></h4>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p>Yazılım ;bilgisayar, makine vb. donanımların yönetimini sağlayan ve insanların makineleri daha etkin kullanması için gerekli komutlar topluluğuna denir. 
        Günümüzde kullandığımız bilgisayarlar, akıllı telefonlar, televizyonlar, bankamatikler gibi çoğu teknolojik alet yazılım içerir. 
        Ben yazılımı daha çok insanların veri girişi yaparak o veri girişinin önceden belirlenmiş bir fonksiyona tabii tutulduğu ve sonuç olarak insanların makinelerden 
        beklediği sonucu çıktı olarak veren bir matematik işlemine benzetiyorum.(Daha basit bir ifadeyle x değerinin f(x) fonksiyonuyla işleme girip y sonucunu vermesi gibi.)</p>
        &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;&emsp; &emsp; &emsp; &emsp; &emsp;
        <img style="align:center" src="/images/makale-resim/yazilim.jpg"><br>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
        <p>Peki nerelerde ve nasıl kullanılır bu bilgisayar yazılımları?<br>
        Dediğimiz gibi çoğu elektronik aletlerde belirli bir programlama diliyle yazılmış yazılım görmekteyiz.</p>
        </p>
        <p>Nedir o zaman bu programlama dilleri ?<br>
        Program, şartlara ve düzene göre yapılması gereken işlemlerin bütünüdür. 
        Terim olarak program ise bilgisayar gibi elektronik aletlerden yapılamasının beklendiği işlerdir.</p>
        <p>Programlama dilleri ise programa yapması gerektiği işi öğretir. 
        Yani bir nevi insanla makine arasındaki anlaşma dilidir.Programlama dilleri de kendi içinde alt gruplara ayrılır ama bu yazımda bunlara detaylı olarak değinmeyeceğim.
        Asıl konumuza dönecek olursak programlama dilleri insanların bilgisayar ve diğer makinelerle anlaşması için kullandığı ortak dildir ve ilerleyen yıllarda da çokça ihtiyaç
         duyacağımız bir alan olmaya doğru hızla ilerliyor.</p>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p style="text-align:center"><i>Bilgisayarlar Yazılımlarından kısaca bahsettik. Görüşmek üzere...</i></p>
		</li>		    
      </ul>
    </div>
  </div>
