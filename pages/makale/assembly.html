...
<div class="w3-black" id="tour">
    <div class="w3-container w3-content w3-padding-64" style="max-width:1000px">
      ...
      <ul class="w3-ul w3-border w3-white w3-text-grey">
		...
		<h4 style="text-align:center"><b>ASSEMBLY PROGRAMLAMA DİLİ</b></h4>
		</li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
            <p>İşlemci dili olarak da bilinen assembly programlama dili, kullanılan bilgisayar yapısına ve işletim sistemi gibi platformlara sıkı sıkıya bağımlı bir dildir.
             Assembly düşük seviyeli bir programlama dili olduğu için C, C++, C#, Pascal gibi yüksek seviyeli dillere nazaran anlaşılması daha zordur. 
             Assembly dili ile program yazılırken kullanılan bilgisayarın donanımsal özellikleri iyi bilinmelidir. 
             Çünkü assembly ile program yazan programcı işlemci ve hafıza ile doğrudan ilgilidir. RAM' deki ve işlemci kaydedicilerindeki verilerle doğrudan oynayabilir.
             Mikro işlemci yalnızca ikili sayı sisteminde (0' lar ve 1'ler)  yazılan komutları anlar. 
             Assembly dilinde yazılan programları makine diline dönüştürmek için assembler adı verilen derleyici kullanılır.</p>
             <img style="align:center" src="/images/makale-resim/Assembler.png"><br>
             <p>Makine dilinin bir karşılığı olan ve komutları kısaltılmış kelimelerden oluşan assembly donanımla yakınlığı açısından 
             sistem programcıları tarafından sıklıkla kullanılır.<br><br>
             <p style="text-align:center">veri → RAM  →(makine dilinde okunur) İŞLEMCİ</p><br></p>
            </li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p><b>ASSEMBLY DİLİNİN AVANTAJLARI</b><p>
        1. Bilgisayar donanımında kuvvetli bir denetim sağlar. Bellek yönetimi açısından en uygun dillerden biridir. 
        İşlemcinin gücünü en iyi şekilde ortaya koyan programlama dilidir.<br>
        2. Küçük boyutlu bellekte az yer kaplayan programlar yazılabilir.<br>
        3. Farklı bir dilin kodları arasında rahatlıkla kullanılabilir.<br>
        4. İyi bilindiği takdirde diğer dillerdeki büyük problemlerin assembly dili ile basit çözümlerinin olduğu anlaşılır.<br>
        <p><b> ASSEMBLY DİLİNİN DEZAVANTAJLARI</b></p>
        <p>1.Yazılan programlar diğer dillere göre daha çok satırdan oluşur.<br>
        2. Donanıma yakınlığı ve bellekte çok az yer kaplaması bakımından bilgisayar virüsleri genelde assembly dili ile yazılır.<br>
        3.İşlemciye birebir bağlıdır. Yapılan yanlış beklenenden kötü sonuçlar doğurabilir.<br>
        4. Assembly dili kodları anlaşılması bakımından diğer dillere göre oldukça zordur. 
        Bu nedenle assembly ile program yazdığınızda ve herhangi bir komutu değiştirmek istediğinizde komutları anlamayabilirsiniz.</p>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p>
        <b>Assembly Programı</b><br>
        MOV AH,02<br>
        MOV DL,41<br>
        INT 21 <br>
        INT 20<br><br>
        <b>Assembler Bilgileri</b><br>
        MS-DOS DEBUG<br>                 
        Boyut: 8 bayt </p>
		</li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
                ...
                <b>Derleyici Bilgileri </b><br>
                MS-DOS için Turbo C 2.01<br>
                Boyut:8830 bayt<br>
                </p>
            </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
            <p><b>Pascal Programı</b><br><p>
                begin<br>
                write(‘A’)<br>
                end.<br>
                <b>Derleyici Bilgileri </b><br>
                MS-DOS için FreePascal 0.9<br>
                Boyut:95644 bayt<br>
                </p>
        </li>       
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p style="text-align:center"><i>Assembly Programlama dilinden kısaca bahsettik. Görüşmek üzere...</i></p>
		</li>		    
      </ul>
    </div>
  </div>
