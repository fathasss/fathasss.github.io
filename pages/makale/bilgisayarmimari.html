...
<div class="w3-black" id="tour">
    <div class="w3-container w3-content w3-padding-64" style="max-width:1000px">
      ...
      <ul class="w3-ul w3-border w3-white w3-text-grey">
		...
		<h4 style="text-align:center"><b>BİLGİSAYAR MİMARİSİ</b></h4>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p>Bilgisayar modüllerinin yapısını, davranışlarını ve kullanıcının ihtiyaçları doğrultusunda nasıl birbirleriyle etkileşim halinde bulunacaklarını kapsar. Mimari programcıya görünen kısımları ifade eder.</p>
        <img style="img-align:center" src="/images/makale-resim/mimari1.jpg"><br><br>
        <p>Bilgisayar mimarisi 3 ana kategoriden oluşur.</p>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p><b>1. Komut Kümesi Mimarisi(ISA)</b>
        <p>-Bir bilgisayar donanımının alt düzey programcıya görünen yüzüdür.<br>
        -Assembly dili<br></p>
        </p>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p><b>2. Mikro Mimari</b><p>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p><b>3. Sistem Tasarımı</b><p>
        -Bilgisayar Bus' larını ve Switch' lerini sisteme bağlar.<br>
        -Memory(hafıza) kontrolcüsü ve hiyerarşilerini yönetir.<br>
        -CPU off load mekanizmasının bazı hafızalara direkt girişini sağlar.<br>
        -Multi-Processing gibi önemli noktaları barındırır.<br></p>
        <p>ISA ve Mikro Mimarin, donanım içinde kendine has tasarımları mevcuttur. Bu tasarım işlemi implemantation olarak adlandırılır. 
        Implemantation donanım tasarım mühendisliği için mimarisel tanımdır. Implemantation da kendi içerisinde 3' e ayrılır.</p>
        <p><b>1.Logic Implemantation</b><br>
        Bu safrada gate seviyelerde mikro mimari içinde blokların tasarımı yapılır.</p>
        <b>2.Circuit Implemantation</b><br>
        Bu safrada ise bazı büyük blokların ve transistör seviyesi temel elementlerinin tasarımı yapılır.</p>
        <b>3.Physical Implemantation</b><br>
        Kablo bağlantılarının yolu belirlenerek bir tahta üzerinde farklı devre elemanlarının yerleştirilmesidir.</p><br>
        <p>BİLGİSAYAR=İşlemci(CPU)+Memory(hafıza)+Giriş/Çıkış(IO)+Arayüzler' den oluşur.</p>
        </p>
        </li>  
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p style="text-align:center"><i>Bilgisayar Mimarisinden kısaca bahsettik. Görüşmek üzere...</i></p>
		</li>		    
      </ul>
    </div>
  </div>
