...
<div class="w3-black" id="tour">
    <div class="w3-container w3-content w3-padding-64" style="max-width:1000px">
      ...
      <ul class="w3-ul w3-border w3-white w3-text-grey">
		...
		<h4 style="text-align:center"><b>İŞLETİM SİSTEMLERİ</b></h4>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		İşletim sistemleri bilgisayar işlemlerinin yürütülmesini sağlayan ana yazılımdır. 
        Sistem yazılımı olarak da bilinen işletim sistemleri bilgisayar donanımlarını yöneten, çalışmasını denetleyen ve uygulama yazılımlarının çalışmasını sağlayan  temel yazılımdır. 
        İşletim sistemlerinin görevleri şunlardır:
        <p><b>1. İşlem Yönetimi</b></p>
        <p>Verilen işlemlerin  belirli bir sırada ve belirli bir zamanda uygulanmasını sağlar.</p>
        <p><b>2. Bellek Yönetimi</b></p>
        <p>Hafızayla ilgili denetleme ve organizasyonu yapar. Bir veri yüklemeniz gerektiğinde veri için hafıza ayırır ya da veriyi silmeniz gerektiğinde verinin hafızada kapladığı alanı boşaltır.
        </p>
        <p><b>3. Giriş-Çıkış Yönetimi</b></p>
        <p>Bilgisayarı çevre birimleri ile (I/O UNIT) arasındaki veri akışını kontrol eder.
        </p>
        <p><b>4. Dosya Yönetimi</b></p>
        <p>Verilerin saklandığı dosyalarla ilgili çalışmaları yönetir.
        </p>
        <p><b>5. Kontrol Yönetimi</b></p>
        <p>Bilgisayar sisteminin güvenliğini ve kontrolünü sağlar.
        </p><br>
        <p>Yani özetle işletim sistemleri bilgisayarın donanım, yazılım ve dosya yönetimini kontrol edip gerçekleştiren en temel yazılımdır.</p><br>
        <img style="align:center" src="/images/makale-resim/windows.png">
        <p><b>İŞLETİM SİSTEMLERİ ÇEŞİTLERİ</b></p>
        <p><b>A) KAPALI KAYNAK KODLU </b></p><br>
        <p><b>A.1) Microsoft Windows</b></p>
        <p>Ünlü bilgisayar firması Microsoft tarafından piyasaya sürülen ve günümüzde en yaygın kullanılan işletim sistemidir.</p>
        <p><b>A.2) MacOS</b></p>
        <p>Apple şirketinin piyasaya sürdüğü ve daha çok grafik ve animasyon kalitesine önem veren işletim sistemidir.</p>
        <p><b>A.3) ChromeOS</b></p>
        <p>Google tarafından Linux çekirdeği esas alınarak tasarlanmış işletim sistemidir. Daha yeni bir işletim sistemi olup şuanlık yalnızca internet için hazırlanmış işletim sistemidir.</p><br>
        <p><b>B) AÇIK KAYNAK KODLU İŞLETİM SİSTEMLERİ (LİNUX)</b></p>
        <p>B.1) Ubuntu<br>B.2) Centos<br>B.3) FreeDos32<br>B.4) GNU/Hurd<br>B.5) Haik<br>B.6) NetBSD<br>B.7) ReactOS<br>B.8) Pardus(Türkiye)<br>
        </p>
        <p>Unix benzeri işletim sistemlerinin genel adı Linux'tur. 
        Bu işletim sistemi kol saatinden bilgisayara hemen hemen her yerde kullanılır. 
        Linux işletim sistemleri Windows ve Mac gibi işletim sistemleri içerisinde ikinci bir işletim sistemi olarak çalışabilmektedir. 
        Kişiye özel kodlanabilir ve tasarlanabilir olması onu kişiye özel bir hale getirir. 
        Windows ortamında kurulu olan programlar Linux işletim sisteminde bir sanal makine kurulmadan çalışmaz.</p>
        <img style="align:center" src="/images/makale-resim/linux.jpg">
		</li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p style="text-align:center"><i>İşletim Sistemlerinden kısaca bahsettik. Görüşmek üzere...</i></p>
		</li>		    
      </ul>
    </div>
  </div>
