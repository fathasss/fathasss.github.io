...
<div class="w3-black" id="tour">
    <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
      ...
      <h4 style="text-align:center">JAVA</h4><br>
      <p style="text-align:center"><i>Nesne Yönelimli Programlama</i></p>
      <ul class="w3-ul w3-border w3-white w3-text-grey">
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Paket Erişimleri</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/java/Java_HAFTA_4.pdf">Download PDF</a>...
        </object></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Listeler</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/java/java_listeler.pdf">Download PDF</a>...
        </object></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Polimorfizm (Çok Biçimlilik)</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/java/Java6_Polimorfizm.pdf">Download PDF</a>...
        </object></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Nesnelerin Başlangıç Durumları</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/java/NesnelerinBaslangıcDurumları(3.hafta).pdf">Download PDF</a>...
        </object></p>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>İş Parçacıkları (Threads) </b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/java/java9.pdf">Download PDF</a>...
        </object></p>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Java Genel Bilinmesi Gerekenler Özet</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/java/java_genel.pdf">Download PDF</a>...
        </object></p>
        </li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Java Örnek Çalışma Soruları</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/java/javaorneksorular.pdf">Download PDF</a>...
        </object></p>
        </li>       
      </ul>
    </div>
