...
<div class="w3-black" id="tour">
    <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
      ...
      <h4 style="text-align:center">C Programlama</h4>
      <ul class="w3-ul w3-border w3-white w3-text-grey">
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Dinamik Bellek Yönetimi</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/prog/C-DBY.pdf">Download PDF</a>...
        </object></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Diziler</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/prog/C-DİZİLER.pdf">Download PDF</a>...
        </object></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Dosya Yönetimi</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/prog/C-DOSYA YÖNETİMİ.pdf">Download PDF</a>...
        </object></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Fonksiyonlar 1</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/prog/C-FONKSİYONLAR1.pdf">Download PDF</a>...
        </object></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Fonksiyonlar 2</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/prog/C-FONKSİYONLAR2.pdf">Download PDF</a>...
        </object></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Katarlar</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/prog/C-KATARLAR.pdf">Download PDF</a>...
        </object></p>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Makrolar</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/prog/C-MAKROLAR.pdf">Download PDF</a>...
        </object></p>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Pointerlar</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/prog/C-POİNTERLAR.pdf">Download PDF</a>...
        </object></p>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Portlar</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/prog/C-PORTLAR.pdf">Download PDF</a>...
        </object></p>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Temel Kütüphane Fonksiyonları</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/prog/C-TEMEL KÜTÜPHANE FONKİYONLARI.pdf">Download PDF</a>...
        </object></p>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Yapılar ve Birlikler</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/prog/C-YAPILAR VE BİRLİKLER.pdf">Download PDF</a>...
        </object></p>
        </li>
      </ul>
    </div>
