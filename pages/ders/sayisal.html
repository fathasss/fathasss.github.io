...
<div class="w3-black" id="tour">
    <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
      ...
      <h4 style="text-align:center">Sayısal Tasarım Notları</h4>
      <ul class="w3-ul w3-border w3-white w3-text-grey">
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Sayısal Tasarım Genel Ders Notu</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/sayisal/Sayısal Tasarım Ders Notları-1.pdf">Download PDF</a>...
        </object></p>
		</li>
      </ul>
    </div>
