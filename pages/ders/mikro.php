...
<div class="w3-black" id="tour">
    <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
      ...
      <h4 style="text-align:center">Mikro İşlemci Uygulamaları Ders Notları</h4>
      <ul class="w3-ul w3-border w3-white w3-text-grey">
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Mikroişlemcili Sistemlere Ait Temel Kavramlar</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/mikro/1.Mikroişlemcili Sistemlere Ait Temel Kavramlar.pdf">Download PDF</a>...
        </object></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Mikroişlemcilerin İç Yapısı</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/mikro/2.Mikroişlemcilerin İç Yapısı.pdf">Download PDF</a>...
        </object></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Mikroişlemci Mimarileri Yapıları</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/mikro/3.Mikroişlemci Mimarileri Yapıları.pdf">Download PDF</a>...
        </object></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>PIC Mikroişlemcileri</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/mikro/4.PIC Mikroişlemcileri.pdf">Download PDF</a>...
        </object></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Kesme</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/mikro/5.Kesme.pdf">Download PDF</a>...
        </object></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Timer</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/mikro/6.Timer.pdf">Download PDF</a>...
        </object></p>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>PWM</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/mikro/7.PWM.pdf">Download PDF</a>...
        </object></p>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>ADC, DAC</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/mikro/8.ADC, DAC.pdf">Download PDF</a>...
        </object></p>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>I2C</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/mikro/9.I2C.pdf">Download PDF</a>...
        </object></p>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>SPI</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/mikro/10.SPI.pdf">Download PDF</a>...
        </object></p>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>UART</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/mikro/11.UART.pdf">Download PDF</a>...
        </object></p>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>OneWire</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/mikro/12.OneWire.pdf">Download PDF</a>...
        </object></p>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>LCD&GLCD</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/mikro/LCD&GLCD.pdf">Download PDF</a>...
        </object></p>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>UNI-DS6 Board Tanıtımı</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/mikro/UNI-DS6 Board Tanıtımı.pdf">Download PDF</a>...
        </object></p>
        </li>
      </ul>
    </div>
