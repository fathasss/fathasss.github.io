...
<div class="w3-black" id="tour">
    <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
      ...
      <h4 style="text-align:center">İnternet Programlama</h4><br>
      <p style="text-align:center"><i>PHP Notları aşağıdadır.</i></p>
      <ul class="w3-ul w3-border w3-white w3-text-grey">
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Hafta 1</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/net-prog/PHP_1.pdf">Download PDF</a>...
        </object></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Hafta 2</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/net-prog/PHP_2.pdf">Download PDF</a>...
        </object></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Hafta 3</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/net-prog/PHP_3.pdf">Download PDF</a>...
        </object></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Hafta 4</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/net-prog/PHP_4.pdf">Download PDF</a>...
        </object></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Hafta 5</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/net-prog/PHP_5.pdf">Download PDF</a>...
        </object></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Hafta 6</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/net-prog/PHP_6.pdf">Download PDF</a>...
        </object></p>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Hafta 7</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/net-prog/PHP_7.pdf">Download PDF</a>...
        </object></p>
        </li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><b>Hafta 8</b>
        <object data="/ornek.pdf#page=2" type="application/pdf" width="100%" height="100%">&emsp;      
                <a href="/pdf/net-prog/PHP_8.pdf">Download PDF</a>...
        </object></p>
        </li>
      </ul>
    </div>
