...
<div class="w3-black" id="tour">
    <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
      ...
      <ul class="w3-ul w3-border w3-white w3-text-grey">
		...
		<p><a style="text-decoration: none" href="/pages/makale/gameengine.php"><b>Oyun Motorları</b></a></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p><a style="text-decoration: none" href="/pages/makale/operatingsystem.php"><b>İşletim Sistemleri</b></a></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p><a style="text-decoration: none" href="/pages/makale/assembly.php"><b>Assembly Programlama Dili</b></a></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p><a style="text-decoration: none" href="/pages/makale/bilgisayar.php"><b>Bilgisayar Bileşenleri</b></a></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p><a style="text-decoration: none" href="/pages/makale/bilgisayarmimari.php"><b>Bilgisayar Mimarisi</b></a></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p><a style="text-decoration: none" href="/pages/makale/bilgisayarhakkinda.php"><b>Bilgisayarla İlgili Genel Konular</b></a></p>
		</li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p><a style="text-decoration: none" href="/pages/makale/programminglanguage.php"><b>Programlama Dilleri ve Seviyeleri</b></a></p>
		</li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p><a style="text-decoration: none" href="/pages/makale/software.php"><b>Bilgisayar Yazılımları Hakkında</b></a></p>
		</li>      
      </ul>
    </div>
  </div>
