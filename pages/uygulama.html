...
<div class="w3-black" id="tour">
    <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
      ...
      <ul class="w3-ul w3-border w3-white w3-text-grey">
		...
		<p><a style="text-decoration: none" href="/pages/uygulamalar/mlkit.php"><b>HUAWEI ML Kit (Face Detection, Object Detection)</b></a></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p><a style="text-decoration: none" href="/pages/uygulamalar/taktak.php"><b>TakTak (Game)</b></a></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p><a style="text-decoration: none" href="/pages/uygulamalar/doyouknow.php"><b> Do You Know ? (Game)</b></a></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p><a style="text-decoration: none"  onclick="alert('Çok yakında... ');" href=""><b>C Uygulamaları</b></a></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p><a style="text-decoration: none" href="/pages/uygulamalar/sparkar.php"><b>SPARK AR ile Facebook ve İnstagram Efektleri Yapımı</b></a></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p><a style="text-decoration: none" href="/pages/uygulamalar/framework.php"><b> BladeFramework (MVC mantığıyla çalışan PHP Framework)</b></a></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p><a style="text-decoration: none" href="/pages/uygulamalar/jsmousefollow.php"><b> JavaScript ile Mouse Takibi</b></a></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p><a style="text-decoration: none" href="/pages/uygulamalar/chatbot.php"><b>Python ile Yapay Zekalı Chatbot MINERVA</b></a></p>
		</li>
		<li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
		<p><a style="text-decoration: none" href="/pages/uygulamalar/csharpformexcel.php"><b>C# FORM Veritabanından Excel Çıktısı Alma</b></a></p>
		</li>
      </ul>
    </div>
  </div>
