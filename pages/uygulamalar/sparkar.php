...
<div class="w3-black" id="tour">
    <div class="w3-container w3-content w3-padding-64" style="max-width:1000px">
      ...
      <ul class="w3-ul w3-border w3-white w3-text-grey">
		...
		<h4 style="text-align:center"><b>SPARK AR ile Facebook ve İnstagram Efektleri Yapımı</b></h4>
		</li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
            <p><b></b></p>
             <p>Spark AR: Facebook' un geliştirdiği ve daha sonra tüm kullanıcıların kullanması için açtığı sosyal medya efekt yapma uygulamasıdır. <br>
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
             <p>Öncelikle <a href="https://sparkar.facebook.com/ar-studio/download/">https://sparkar.facebook.com/ar-studio/download/</a> 
             adresinden Spark AR uygulamasını indirip bilgisayarınıza kurmanız gerekmektedir. Uygulamayı kurduktan sonra yeni proje açıp başlayabiliriz.</p>
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item">
                <img style="align:center;max-width:100%;height:auto;" src="/images/sparkar1.png">
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
             <p>New Project' e tıkladıktan sonra karşınıza aşağıdaki gibi bir ekran gelecek. Ekranda da gördüğünüz gibi program bize bir prototip gösteriyor.
              Daha önce Unity, Unreal Engine gibi oyun motorları kullandıysanız uygulamadaki terimlerin çoğu tanıdık gelecektir.</p>
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item">
                <img style="align:center;max-width:100%;height:auto;" src="/images/sparkar2.png">
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
             <p>Face Tracker() öğesine sağ tıklayıp Face Mesh ekleyebiliriz.Face Mesh prototip yüzde de gördüğünüz gibi bir kalıp oluşturur. Bu kalıbı kullanmak için 
             Face Mesh öğesinde sağ tarafta Materials öğresini göreceksiniz. Materials öğresinden oluşturulan materyale bir Textures atayarak efektin oluşmasını sağlayabiliriz.</p>
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item">
                <img style="align:center;max-width:100%;height:auto;" src="/images/sparkar3.png">
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
             <p>Üst resimde de gördüğünüz Shader Type öğesinde materiyalin özelliğini değiştirebilirsiniz. Yüz efekti yapacağımız için Face Paint olması daha iyidir.
             Ardından Texture sekmesine Photoshop' da tasarladığınız bir efekti koyablirsiniz.</p>
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item">
                <img style="align:center;max-width:100%;height:auto;" src="/images/sparkar4.png">
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
             <p>Materiyals öğresinden efektin opaklığını,parlaklığını vs ayarlayabilirsiniz. Yaptığınız efekti Dosya sekmesinden Ctrl+S ile kaydedebilirsiniz. Ya da telefonunuzu
             USB ile bilgisayarınıza bağlayıp Spark AR Player uygulamasıyla deneyebilirsiniz.<br>
             Yaptığınız efekti İnstagram' a veya Facebook' a atmak isterseniz <a href="https://www.facebook.com/sparkarhub/dashboard/">https://www.facebook.com/sparkarhub/dashboard/</a>
             adresinden yükleyebilirsiniz.</p>
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
             <p>İyi çalışmalar :)</p>
            </li>
