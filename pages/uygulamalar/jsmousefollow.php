...
<div class="w3-black" id="tour">
    <div class="w3-container w3-content w3-padding-64" style="max-width:1000px">
      ...
      <ul class="w3-ul w3-border w3-white w3-text-grey">
		...
		<h4 style="text-align:center"><b>JavaScript ile Mouse Takibi </b></h4>
		</li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
            <p><b></b></p>
             <p>JavaScript' in onlarca özelliğini günden güne keşfetmeye devam ediyorum :) Bugünki mouse takip uygulamam da bunlardan birisi :)<br>
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
             <p>İnternet sayfalarında mouse takibinin veya mouse konumunun önemi, kullanıcı sitemize girdiğinde bastığı butonları tespit etmek ve 
             bu sayede en çok kullanılan sekmeleri anlamamıza olanak sağlar. Bu sayede özellikle bir E-ticaret sitesinde kullanıcının ilgi odaklarını anlayıp
             onlara ilgilendikleri alanlarla ilgili sayfaların gelmesini sağlayabliriz. Mouse takip olayıyla ısı haritası çıkarabilir ve çoğunlukla girilen sekmeleri 
             veya girilen sekmelerde tıklanan alanları analiz edebiliriz. Bu yaptığımız analizler sayesinde pazarlama anlamında kazancımızı katlama imkanımız veya daha çok ürün
             satma imkanımız bulunmaktadır. Aşağıda mouse takibi yapan Script' i inceleyebilirsiniz. </p>
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item">
                <img style="align:center;max-width:100%;height:auto;" src="/images/mousefollow1.png">
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
             <p>Bu scripti kullandığınızda imlecin fare hareketini takip ettiğini ve takip ederken değiştirdiği konumu koordinat düzlemine göre görebilirsiniz.<br>
            Belirli bir canvas içinde de fare hareketinin peşinde dolaşan kırmızı noktayı görebilirsiniz. Kırmızı nokta imlecin bulunduğu konumu gösterir.</p>
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item">
                <img style="align:center;max-width:100%;height:auto;" src="/images/mousefollow2.png">
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
             <p>Şimdide mouse event yani fareye tıklanma olayında farenin konumunu koordinat düzlemine göre yazdıran scripti inceleyelim. <br>
            Mouse takibini yaparken kullandığımız fonksiyonun bir benzerini konumu yazdırırken kullanacağız. Mouse' un konumunu yazdıran script aşağıdaki gibidir.</p>
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item">
                <img style="align:center;max-width:100%;height:auto;" src="/images/mousefollow3.png">
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
             <p>Bu konumu NodeJS kullanarak bir veritabanında saklayabiliriz ve sakladıktan sonra bu verileri veritabanından çekip işleyebiliriz. Bu verilerde en çok kullanılan konumlardaki sekmeleri
                 veya en çok tıklanan butonları izleyebiliriz. Uygulamanın çalışan haline aşağıdaki linkten ulaşabilirsiniz.
             </p>
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"><a href="../javascript.html">JavaScript for Mouse Follow</a></p>
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
             <p>İyi çalışmalar :)</p>
            </li>
