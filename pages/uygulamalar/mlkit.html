...
<div class="w3-black" id="tour">
    <div class="w3-container w3-content w3-padding-64" style="max-width:1000px">
      ...
      <ul class="w3-ul w3-border w3-white w3-text-grey">
		...
		<h4 style="text-align:center"><b>HUAWEI ML_KIT</b></h4>
		</li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
            <p><b>Yüz / Vücutla İlgili Hizmetler</b></p>
            <p><b>Yüz tanıma</b></p>
             <p>Yüz algılama hizmeti, yüz ifadesi, yaş, cinsiyet ve aşınma dahil olmak üzere kullanıcı yüzünüzün şekillerini ve özelliklerini algılayabilir. 
             Örneğin, video görüşmeleri sırasında kullanıcıların yüzlerini dinamik olarak güzelleştiren uygulamalar geliştirmek için hizmeti kullanabilirsiniz.<br><br>
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
            <p><b>Nesne Algılama ve İzleme</b></p>
             <p>Nesne algılama ve izleme hizmeti, bir görüntüdeki birden çok nesneyi algılayıp izleyebilir, 
             böylece gerçek zamanlı olarak konumlandırılabilir ve sınıflandırılabilirler. Bu, görüntüleri incelemek ve tanımak için kullanışlıdır. 
             ML Kiti her görüntüdeki nesneleri algılayabilir ve görüntüdeki ilgili konumlarını gerçek zamanlı olarak alabilir. 
             Ayrıca, istenmeyen nesneleri filtreleyen uygulamalar geliştirmek için de ideal bir seçimdir.<br><br>
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
             <p>HUAWEI Developer hesabı açarak kolaylıkla kullanabileceğiniz uygulamalarınıza entegre edebileceğiniz ML_Kit kütüphaneleri ile 
             yüz algılama, obje algılama ve daha bir sürü özelliği kullanabilirsiniz.<br>
             Hazır HUAWEI kütüphanelerini uygulamanıza entegre etmek ve kullanmak için Android Studio' daki uygulamanızın, main kodunuza ve kullanacağınız Java dosyalarına aşağıdaki Java Kodlarınızı ekleyebilirsiniz.<br>
             <li class="w3-padding"><p style="text-align:center" class="w3-bar-item">
                <p>import com.huawei.hms.mlsdk.common.MLPosition;<br>
                import com.huawei.hms.mlsdk.face.MLFace;<br>
                import com.huawei.hms.mlsdk.face.MLFaceKeyPoint;<br>
                import com.huawei.hms.mlsdk.face.MLFaceShape;<br>
                import com.huawei.mlkit.example.camera.GraphicOverlay;</p></li>
            </li>
            <ul class="w3-ul w3-border w3-white w3-text-grey">
                <li class="w3-padding"><p style="text-align:center" class="w3-bar-item">
                <object data="/ornek.apk#page=2" type="application/apk" width="100%" height="100%">&emsp;      
                        <a style="text-decoration:none" href="" onClick="alert('Benimle iletişime geçin. fatihhas2609@gmail.com');"><p style="text-align:center"><b>Download APK...</b></p></a>
                </object></p>
		        </li>
            </ul>    
      </ul>
