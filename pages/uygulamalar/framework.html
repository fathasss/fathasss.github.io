...
<div class="w3-black" id="tour">
    <div class="w3-container w3-content w3-padding-64" style="max-width:1000px">
      ...
      <ul class="w3-ul w3-border w3-white w3-text-grey">
		...
		<h4 style="text-align:center"><b>BladeFramework (MVC mantığıyla çalışan PHP Framework)</b></h4>
		</li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
            <p><b></b></p>
             <p>Bir kaç gün önce geliştirmeye başladığım Web siteleri yapmak ve bunları kontrol etmek amacıyla yaptığım Framework' ü sizlerle paylaşmak istedim.<br>
             Benimle birlikte geliştirmek isterseniz iletişime geçebilirsiniz.<br>
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
             <p>Öncelikle size klasör yapısından bahsedeyim. Aşağıda Framework' ün klasör yapısını görmektesiniz.</p>
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item">
                <img style="align:center;max-width:100%;height:auto;" src="/images/blade1.png">
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
             <p>Bu klasör yapısında index.php dosyası, Web siteniz tarayıcı üzerinde açıldığında ilk uğrayacağı sayfadır. Yani kullanıcının siteniz hakkında göreceği ilk sayfayı içerir.<br>
             Burada meta etiketleri, scriptlerin bağlantıları ve bootstrap metalarını içerir.<br>
             Kendinize has kullanabilmeniz için tasarımınızı yapıp arkaplan bağlantılarına geçebilirsiniz. Ayrıca ReadMe.txt dosyasında klasör yapıları anlatılmaktadır.<br>
             ReadMe.txt dosyası aşağıdaki gibidir.</p>
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item">
                <img style="align:center;max-width:100%;height:auto;" src="/images/blade2.png">
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
             <p>ReadMe.txt dosyasını okuduktan sonra yapmak istediğiniz veritabanı işlemlerini, web sitenizde link kontrolü veya eklemek istediğiniz SEO fonksiyonlarını ekleyebilirsiniz.</p>
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item">
                <img style="align:center;max-width:100%;height:auto;" src="/images/blade3.png">
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
             <p>Yukarıda görmüş olduğunuz Scripts klasörünün iç yapısıdır. Buraya kullanmak istediğiniz JavaScript kütüphanelerini, NodeJS kütüphanelerini, AngularJS benzeri kütüphaneleri ekleyebilirsiniz.<br>
             Buraya eklediğiniz kütüphaneleri index.php dosyasının içindeki script etiketine eklediğinizde artık web sitenin tüm sayfalarında arzu ettiğiniz gibi kullanabilirsiniz.<br>
             Framework' ün logosu şimdilik aşağıdaki gibidir.</p>
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item">
                <img style="align:center;max-width:100%;height:auto;" src="/images/blade4.png">
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
             <p>İyi çalışmalar :)</p>
            </li>
