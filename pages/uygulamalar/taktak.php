...
<div class="w3-black" id="tour">
    <div class="w3-container w3-content w3-padding-64" style="max-width:1000px">
      ...
      <ul class="w3-ul w3-border w3-white w3-text-grey">
		...
		<h4 style="text-align:center"><b>TAKTAK</b></h4>
		</li>
        <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
            <p><b></b></p>
             <p> Stack uygulamasının Unity oyun motoru ve C# kullanılarak yapılmış halidir.<br>
             Amacınız küpleri üst üste tutmaya çalışmaktır.<br>
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item"></p>
             <p>Uygulamanın klasör yapısı Assets,Scenes,Scripts,İmage,Material şeklindedir. Uygulamada Unity kullanılarak ilk aşamada sahneye 11 adet 
             küp eklenmiştir. Küplerin sağ sol hareketleri sıralı olup x,y ve z eksenlerinde koordineli bir şekilde hareket etmektedir.
             Kameranın ilerleyişi küp yerleştirildikçe hareket edecektir. Küplerin kırılma olayı, dokunulduğu yerde kaldıktan sonra,
             Unity' nin düşme efekti kullanılarak büyük parçadan ayrılması sağlanmıştır. 6 kere üst üste koyulduğunda kombo oluşur ve kombo devam ettikçe küpler büyümeye 
             başlar.
             Uygulamanın ekran görüntüleri aşağıdaki gibidir.<br><br>
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item">
                <img style="align:center" width="250" height="450" src="/images/WhatsApp Image 2020-07-14 at 19.53.25 (1).jpeg">
            </li>
            <li class="w3-padding"><p style="text-align:center" class="w3-bar-item">
                <img style="align:center" width="250" height="450" src="/images/WhatsApp Image 2020-07-14 at 19.53.25.jpeg">
            </li>
            <ul class="w3-ul w3-border w3-white w3-text-grey">
                <li class="w3-padding"><p style="text-align:center" class="w3-bar-item">
